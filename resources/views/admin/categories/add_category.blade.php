...
<div role="main" class="col-md-9 ml-sm-auto col-lg-10 mt-4 px-4">
    ...
    <p class="h5 text-secondary"><strong>Add Category</strong></p>
    <hr>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><strong class="text-muted">{{ __('Add Category') }}</strong></div>

                    <div class="card-body">
                        <form class="form-signin" id="loginform" method="post" action="{{ url('/admin/add-category') }}" >
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="category_name" id="category_name" class="form-control" placeholder="Category Name" required autofocus>
                                </div>
                                <span class="mx-3" id="category_exists"></span>
                            </div>
                            
                            <div class="row mt-2">
                                <label for="category_option" class="col-md-4 col-form-label text-md-right">Category Options</label>
