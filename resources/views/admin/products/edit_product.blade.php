...
<div role="main" class="col-md-9 ml-sm-auto col-lg-10 mt-4 px-4">
    ...
    <p class="h5 text-secondary"><strong>Edit Product</strong></p>
    <hr>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header"><strong class="text-muted">{{ __('Edit Product') }}</strong></div>

                    <div class="card-body">
                        <form class="form-signin" enctype="multipart/form-data" id="loginform" method="post" action="{{ url('/admin/edit-product/'.$product_details->id) }}" >
                            @csrf
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6 mt-3">
                                    <input type="text" name="product_name" id="product_name" class="form-control" value="{{ $product_details->name }}" required> 
                                </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6 mt-3">
                                    <input type="text" name="product_code" id="product_code" class="form-control" value="{{ $product_details->code }}" required>
                                </div>
                                <span class="mx-3" id="product_exists"></span>
                            </div>
                            ...
                            <div class="row mt-2">
                                ...
                                <div class="col-md-6 mt-3">
                                    <input type="text" name="product_colour" id="product_colour" class="form-control" value="{{ $product_details->colour }}" >
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <textarea type="" name="description" id="description" class="form-control" required> {{ $product_details->description }} </textarea>
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="price" id="price" class="form-control" value="{{ $product_details->price }}" required> 
                                </div>
                            </div>
                            ...
                            <div class="row mt-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <img style="width:200px" height="100px" src="{{ asset('images/products/small/'.$product_details->image) }}" alt="" >
                                </div>
                            </div> 
